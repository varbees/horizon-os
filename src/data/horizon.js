...
export const journeyEntries = [
  {
    ...
    type: "Field Scout",
    anchor: "Body + Spec",
    title: "West Hill scout log",
    location: "West Hill ridge",
    coordinates: {
      latitude: 13.7118453,
    ...
    evidence: "Google Earth KML placemark captured from field exploration.",
    lesson: "The safe-haven plan needs real terrain evidence, not only abstract planning.",
    next: "Create a reusable field-scout template for PlantSage and offgrid scouting.",
  },
  {
    ...
    location: "Horizon OS",
    evidence: "MacBook/workstation, INR 6L support fund, and INR 3L expenses buffer added as trackable targets.",

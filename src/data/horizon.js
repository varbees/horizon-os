...
export const hackathonEvents = [
  {
    ...
    lane: "Hackathon",
    color: "#ba4d35",
    activity: "Create repo, AGENTS.md, env stubs, Meta/Supabase/Vercel/OpenAI readiness, and demo storyboard.",
    output: "Empty repo is no longer empty: docs organized, stack chosen, credentials checklist visible.",
  },
  {
    id: "dialysis-kickoff",
    date: "2026-05-25",
    time: "19:00 - 20:30",
    title: "OpenAI x Outskill Kickoff",
    lane: "Hackathon",
    color: "#2558d8",
    activity: "Attend virtual onboarding call. Capture rules, judging criteria, health-app constraints, and submission format.",
    output: "One decision note in Horizon OS: exact deliverables, deadline, allowed APIs, and judging rubric.",
  },
  {
    ...
    lane: "Hackathon",
    color: "#9a6500",
    activity: "Submit product brief / MVP direction for DialysisSaathi.",
    output: "Submitted direction: WhatsApp lab ingest, renal trend card, diet stoplight, family summary.",
  },
  {
    ...
    lane: "Hackathon",
    color: "#087861",
    activity: "Submit working demo, repo, Loom, screenshots, and final write-up.",
    output: "Public URL, WhatsApp demo path, GitHub repo, AGENTS.md, eval evidence, 90-second Loom.",
  },
];
...
export const strategicCourse = [
  {
    ...
    decision: "From May 24-30, treat this as the weekly build priority because the request was approved and the deadline is hard.",
    calendarRule: "Hackathon tasks override Flex and some Product blocks this week only; after final submission, PhotoSelect returns to flagship priority.",
  },
  {
...
export const documents = [
  {
    ...
    next: "Use docs in `~/Desktop/bolting/dialysissaathi/docs/` as source; create AGENTS.md, repo scaffold, env checklist, and demo storyboard.",
  },
  {
    id: "operating-plan",
...
export const phaseGates = [
  {
    ...
    order: 0,
    label: "May 24-30",
    title: "DialysisSaathi sprint",
    target: "Working WhatsApp MVP, repo, AGENTS.md, eval proof, 90-sec Loom, final hackathon submission.",
    control: "Bend the week around the deadline; do not expand beyond lab ingest, trend card, diet stoplight, and handoff PDF.",
  },
  {
    id: "weeks-1-4",
    order: 1,
...
export const actionTasks = [
  {
    ...
    dueAt: "2026-05-24",
    sortOrder: 1,
    evidence: "Planning files live under `dialysissaathi/docs/`; extract stack, demo moments, risks, and day plan into AGENTS.md.",
  },
  {
    ...
    dueAt: "2026-05-24",
    sortOrder: 2,
    evidence: "Meta WhatsApp app/number, Supabase, Vercel, OpenAI key, GitHub repo, env stubs, and public tunnel path identified.",
  },
  {
    ...
    dueAt: "2026-05-25",
    sortOrder: 3,
    evidence: "Write down whether health apps are allowed, final deadline time, repo requirements, demo format, Codex-usage expectations, and team rules.",
  },
  {
    ...
    phaseId: "hackathon-week",
    lane: "Hackathon",
    title: "Create DialysisSaathi AGENTS.md and safety guardrails",
    priority: "high",
    revenueImpact: 0,
    dueAt: "2026-05-25",
    sortOrder: 4,
    evidence: "Include repo tree, commands, domain glossary, no diagnosis, no medication dosing, PHI redaction, test commands, and Codex skill plan.",
  },
  {
    ...
    dueAt: "2026-05-25",
    sortOrder: 5,
    evidence: "Judge-visible path: send hi -> menu; send image/PDF -> private storage row; idempotent inbound message row.",
  },
  {
    ...
    dueAt: "2026-05-26",
    sortOrder: 6,
    evidence: "8 anonymized lab fixtures, strict JSON schema, lab_values inserts, KDOQI target flags, and field-level accuracy notes.",
  },
  {
  ...
  },
  {
    ...
    dueAt: "2026-05-28",
    sortOrder: 8,
    evidence: "Brief names the user, scope, WhatsApp demo path, safety boundary, and 4 demo moments.",
  },
  {
  ...
  },
  {
    ...
    dueAt: "2026-05-30",
    sortOrder: 10,
    evidence: "Public URL, live WhatsApp path or recorded fallback, GitHub README, AGENTS.md, eval evidence, and 90-second Loom.",
  },
  {

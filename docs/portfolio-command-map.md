...
This document turns `~/Desktop/bolting/*` into one managed portfolio instead of a field of tempting side quests.
...
- Turn RateGuard into a narrow landing page plus conformance-suite checklist.
- Create one PhotoSelect case study page.
- Keep WidgetForge parked unless the Component Forge audience demands Android widgets.

### Week 4

- Review cash, replies, calls, pilot friction, and active project count.
- Kill or park anything that did not create proof, pipeline, or clarity.
- Lock next month around the highest-response buyer segment.

## Resurrection Gate

A parked or archived project can become active only if all five answers are concrete:

1. Who pays?
2. What painful job do they already spend money or time on?
3. Can the MVP ship in two weeks?
4. Can you reach 25 buyers this week?
5. Does it strengthen PhotoSelect, Antharmaya, Component Forge, Agent Linux Control, or RateGuard?

If any answer is vague, the project stays parked.
